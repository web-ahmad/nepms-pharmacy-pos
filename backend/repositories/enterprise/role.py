...
DEFAULT_ROLES: Dict[str, Dict] = {
    ...
    "General Manager": {
        ...
        "permissions":  _merge(
            _SALES_FULL, _INVENTORY_FULL, _PURCHASE_FULL,
            _ACCOUNTING_FULL, _HR_FULL, _CRM_FULL, _REPORTS_FULL,
            _AUDIT_READ, _BRANCHES_MANAGE, _SETTINGS_FULL,
            _perm("users:view", "users:create", "users:update",
                  "prescriptions:manage", "compliance:view",
                  "notifications:manage", "executive_dashboard:view"),
        ),
    },
    "Branch Manager": {
    ...
    "Warehouse Manager": {
        "branch_scope": "selected_branches",
        "data_scope":   "branch",
        "color":        "#ea580c",
        "icon":         "Warehouse",
        "sort_order":   9,
        "permissions":  _perm(
            ...
            "medicines:view", "medicine_batches:manage",
            "warehouses:manage", "rack_management:manage",
            "stock_transfers:manage", "stock_reservations:manage",
            "physical_audit:manage", "inventory_adjustments:view",
            "goods_receiving:manage",
            "purchase:view", "purchase_orders:view",
            "reports:view",
        ),
    },
    "Store Keeper": {
        ...
        "permissions":  _perm(
            "dashboard:view",
            "inventory:view", "inventory:update",
            "medicines:view", "medicine_batches:view",
            "warehouses:view", "rack_management:view",
            "stock_transfers:view", "stock_transfers:create",
            "stock_reservations:view",
            "physical_audit:view", "physical_audit:create",
            "goods_receiving:view", "goods_receiving:create",
            "purchase:view",
        ),
    },
    "Purchase Manager": {
        ...
        "permissions":  _merge(
            _PURCHASE_FULL,
            _perm("dashboard:view", "analytics:view",
                  "inventory:view", "medicines:view", "medicine_batches:view",
                  "reports:view", "reports:export",
                  "expenses:view", "accounting:view", "payables:view"),
        ),
    },
    "Purchase Officer": {
        "branch_scope": "assigned_branch",
    ...
    "Finance Manager": {
        ...
        "sort_order":   13,
        "permissions":  _merge(
            _ACCOUNTING_FULL, _REPORTS_FULL,
            _perm("dashboard:view", "analytics:view",
                  "expenses:manage", "tax_management:manage",
                  "payroll:view", "supplier_payments:approve",
                  "audit:view", "audit:export", "settings:tax"),
        ),
    },
    "Accountant": {
        "branch_scope": "assigned_branch",
    ...
    "HR Manager": {
        ...
        "permissions":  _merge(
            ...
            _perm("dashboard:view", "analytics:view",
                  ...
                  "notifications:manage", "settings:hr"),
        ),
    },
    "HR Officer": {
        "branch_scope": "assigned_branch",
        ...
        "permissions":  _perm(
            ...
            "attendance:manage", "leaves:manage", "shifts:view",
            "departments:view", "designations:view",
            "payroll:view", "employee_documents:manage",
            "employee_tasks:manage", "reports:view",
        ),
    },
    "Marketing Manager": {
        "branch_scope": "all_branches",
        ...
        "sort_order":   17,
        "permissions":  _merge(
            _CRM_FULL, _REPORTS_FULL,
            _perm("dashboard:view", "analytics:view",
                  "customers:view", "customer_loyalty:manage",
                  "customer_referrals:manage",
                  "notifications:manage", "settings:crm"),
        ),
    },
    "CRM Executive": {
        "branch_scope": "all_branches",
        ...
        "permissions":  _perm(
            "dashboard:view",
            "crm:manage", "customers:manage",
            "customer_wallet:view", "customer_wallet:create",
            "customer_loyalty:manage", "customer_referrals:manage",
            "campaigns:view", "campaigns:create",
            "coupons:view", "gift_vouchers:view",
    ...
    "Compliance Officer": {
        ...
        "permissions":  _perm(
            ...
            "compliance:manage",
            "system_logs:view", "system_logs:export",
            "reports:view", "reports:export",
            "users:view", "roles:view",
            "settings:view", "prescriptions:view",
    ...
    "System Auditor": {
        ...
        "permissions":  _perm(
            "dashboard:view", "analytics:view",
            "pos:view", "sales:view", "sales_returns:view",
            "customers:view", "customer_loyalty:view",
            "inventory:view", "medicines:view", "warehouses:view",
            "stock_transfers:view", "physical_audit:view",
            "purchase:view", "purchase_orders:view", "suppliers:view",
            "accounting:view", "journal_entries:view",
            "general_ledger:view", "expenses:view",
            "hr:view", "employees:view", "attendance:view", "payroll:view", "leaves:view",
            "crm:view", "marketing:view", "campaigns:view",
            "prescriptions:view", "doctors:view",
            "branches:view", "users:view", "roles:view", "settings:view",
            "audit:view", "audit:export", "audit:investigate",
            "audit:risk", "audit:compliance",
            "compliance:view", "system_logs:view", "system_health:view",
            "reports:view", "bi_reports:view", "notifications:view",
        ),
    },
    "Doctor": {
        "branch_scope": "assigned_branch",
        ...
        "permissions":  _perm(
            "dashboard:view",
            "prescriptions:manage", "doctors:view",
            "medicines:view", "customers:view", "customers:create",
        ),
    },
    "Receptionist": {
        "branch_scope": "assigned_branch",
    ...
    "Quality Assurance": {
        ...
        "permissions":  _perm(
            ...
            "reports:view", "reports:export", "system_logs:view",
        ),
    },
    "IT Support Engineer": {
        "branch_scope": "global",
        ...
        "permissions":  _perm(
            "dashboard:view",
            "system_health:view", "system_health:manage",
            "system_logs:view", "system_logs:export",
            "backups:view", "backups:create",
            "notifications:manage",
            "ocr_queue:manage",
            "settings:view", "settings:api", "settings:modules",
