                  ...
                  <tr key={emp.id} className="hover:bg-emerald-50/40 dark:hover:bg-emerald-950/20 transition-colors group">
                    ...
                    <td className="px-5 py-3.5 text-right">
                      <div className="flex items-center justify-end gap-1">
                        ...
                        <button onClick={() => onDelete(emp.id)} className="p-1.5 rounded-lg text-gray-400 hover:bg-red-50 hover:text-red-700 dark:hover:bg-red-900/30 dark:hover:text-red-400 transition-colors" title="Delete permanently">
