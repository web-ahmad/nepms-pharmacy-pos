...
export default function CashierPortalPage() {
  ...
  // The sidebar's Close Shift button (shown on every page) sends the cashier
  // here with ?close=1 — the cash-counting flow only lives on this page.
  // Read straight off the URL rather than useSearchParams(), which would drag
  // a Suspense-boundary requirement into this client-only page.
  useEffect(() => {
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl border border-outline-variant bg-surface-container-lowest p-4 shadow-sm flex flex-col h-[calc(100vh-280px)]">
                ...
                <div className="pt-4 mt-2 border-t border-outline-variant space-y-2">
                  ...
                  <Link href="/cashier/ledger" className="w-full flex items-center justify-center gap-2 rounded-lg bg-surface-container-lowest py-2 text-xs font-bold text-on-surface-variant hover:text-primary transition-colors">
